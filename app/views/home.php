<section class="caixa">
				<div class="base-home mt-4 pb-4">
					...
					<div class="rows">
						...
						<div class="col-3 mb-3">
							<article class="cx-home">
								<div class="cx-body">
									...
									<div>
										<strong>20</strong>
										<small>Pacientes adicionados</small>
									</div>
								</div>
							</article>
						</div>
						<div class="col-3 mb-3">
							<article class="cx-home excluido">
								<div class="cx-body">
									...
									<div>
										<strong>200</strong>
										<small>Pacientes excluídos</small>
									</div>
								</div>
							</article>
						</div>
						...
						<div class="col-3 mb-3">
							<article class="cx-home">
								<a href="<?php echo URL_BASE ."paciente/create" ?>" class="btn cx-body">
									<i><img src="<?php echo URL_BASE ?>/assets/img/icons8_add-user.svg"></i>
									<div>cadastro</div>
								</a>
							</article>
						...
						<div class="col-3 mb-3">
							<article class="cx-home">
								<a href="<?php echo URL_BASE ."paciente" ?>" class="btn cx-body">
